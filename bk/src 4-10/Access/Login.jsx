...
const Login = () => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      const response = await axios.post('https://www.santhoshavidhyalaya.com/SVS/api/login', payload);
      ...
      if (response.data.user_type === 'admin') {
        window.location.href = '/svsportaladmin/dashboard';
      } else {
                ...
                <Form method='post' onSubmit={handleSubmit(onSubmit)}>
                  ...
                  <Form.Group style={{ padding: '0px 98px 0px 0px' }} className="mb-3" controlId="formBasicPassword">
                    <FormControl style={{ width: '100%' }} variant="outlined" className='mb-3 mx-5 w-100'>
                      ...
                      <OutlinedInput fullWidth {...register('passSvs', { required: 'Password is required' })}
