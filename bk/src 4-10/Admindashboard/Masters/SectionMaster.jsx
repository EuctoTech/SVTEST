...
////////////// Data LIST ////////////////////
  const fetchSections = async () => {
    try {
      const response = await fetch('https://www.santhoshavidhyalaya.com/SVS/api/section-master-read');
  ...
  const createSection = async () => {
    try {
      const response = await fetch('https://www.santhoshavidhyalaya.com/SVS/api/section-master-insert', {
        method: 'POST',
        headers: {
  ...
  try {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        try {
          await fetch(`https://www.santhoshavidhyalaya.com/SVS/api/section-master-delete`, {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json',
            },
...
const editSectionSubmit = async () => {
    try {
      const response = await fetch(`https://www.santhoshavidhyalaya.com/SVS/api/section-master-update`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
