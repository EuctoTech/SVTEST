...
class EightStandardFeeTable8 extends React.Component {
  ...
  componentDidMount() {
    ...
    $(document).ready(function () {
      $('#EightStandardFeeTable8').DataTable({
        destroy: true,
        processing: true,
        serverSide: true,
        ajax: {
          url: 'https://www.santhoshavidhyalaya.com/SVSTEST/api/studentsMaps/11',
          type: 'POST',
        },
        dom: 'lfBrtip',
        buttons: [
  ...
  editLKG = async () => {
    try {
      ...
      const data = await response.json();
      $('#EightStandardFeeTable8').DataTable().ajax.reload();
      Swal.fire({
        icon: 'success',
...
<div className='pt-5' >
    <Modal className='mt-5' show={this.state.showModal} onHide={this.closeModal}>
       <Modal.Header closeButton>
         <Modal.Title>8th Standard</Modal.Title>
       </Modal.Header>
       <Modal.Body>
         <Form>
         <Form.Control 
     ...
     <div className="container">
       ...
       <table id="EightStandardFeeTable8" class="display">
         <thead>
         <tr>              
           <th>Student Name</th>
           <th>Roll No</th>
...
export default EightStandardFeeTable8
