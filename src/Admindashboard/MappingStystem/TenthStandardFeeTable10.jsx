...
class TenthStandardFeeTable10 extends React.Component {
  ...
  componentDidMount() {
    ...
    $(document).ready(function () {
      $('#TenthStandardFeeTable10').DataTable({
        destroy: true,
        processing: true,
        serverSide: true,
        ajax: {
          url: 'https://www.santhoshavidhyalaya.com/SVSTEST/api/studentsMaps/10',
          type: 'POST',
        },
        dom: 'lfBrtip',
        buttons: [
  ...
  editLKG = async () => {
    try {
      ...
      const data = await response.json();
      $('#TenthStandardFeeTable10').DataTable().ajax.reload();
      Swal.fire({
        icon: 'success',
...
<div className='pt-5' >
    <Modal className='mt-5' show={this.state.showModal} onHide={this.closeModal}>
       <Modal.Header closeButton>
         <Modal.Title>10th Standard</Modal.Title>
       </Modal.Header>
       <Modal.Body>
         <Form>
         <Form.Control 
     ...
     <div className="container">
       ...
       <table id="TenthStandardFeeTable10" class="display">
         <thead>
         <tr>              
           <th>Student Name</th>
           <th>Roll No</th>
...
export default TenthStandardFeeTable10
