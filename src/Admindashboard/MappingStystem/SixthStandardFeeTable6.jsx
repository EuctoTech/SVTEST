...
class SixthStandardFeeTable6 extends React.Component {
  ...
  componentDidMount() {
    ...
    $(document).ready(function () {
      $('#SixthStandardFeeTable6').DataTable({
        destroy: true,
        processing: true,
        serverSide: true,
        ajax: {
          url: 'https://www.santhoshavidhyalaya.com/SVSTEST/api/studentsMaps/6',
          type: 'POST',
        },
        dom: 'lfBrtip',
        buttons: [
  ...
  editLKG = async () => {
    try {
      ...
      const data = await response.json();
      $('#SixthStandardFeeTable6').DataTable().ajax.reload();
      Swal.fire({
        icon: 'success',
...
<div className='pt-5' >
    <Modal className='mt-5' show={this.state.showModal} onHide={this.closeModal}>
       <Modal.Header closeButton>
         <Modal.Title>6th Standard</Modal.Title>
       </Modal.Header>
       <Modal.Body>
         <Form>
         <Form.Control 
     ...
     <div className="container">
       ...
       <table id="SixthStandardFeeTable6" class="display">
         <thead>
         <tr>              
           <th>Student Name</th>
           <th>Roll No</th>
...
export default SixthStandardFeeTable6
