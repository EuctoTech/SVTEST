...
class SecondStandardFeeTable2 extends React.Component {
 ...
 constructor(props) {
  ...
  componentDidMount() {
    ...
    $(document).ready(function () {
      $('#SecondStandardFeeTable2').DataTable({
        destroy: true,
        processing: true,
        serverSide: true,
        ajax: {
          url: 'https://www.santhoshavidhyalaya.com/SVSTEST/api/studentsMaps/2',
          type: 'POST',
        },
        dom: 'lfBrtip',
        buttons: [
  ...
  editLKG = async () => {
    try {
      ...
      const data = await response.json();
      $('#SecondStandardFeeTable2').DataTable().ajax.reload();
      Swal.fire({
        icon: 'success',
...
<div className='pt-5' >
    <Modal className='mt-5' show={this.state.showModal} onHide={this.closeModal}>
       <Modal.Header closeButton>
         <Modal.Title>2nd Standard</Modal.Title>
       </Modal.Header>
       <Modal.Body>
         <Form>
         <Form.Control 
       ...
       <Modal.Footer>
         ...
         <div className="container">
           ...
           <table id="SecondStandardFeeTable2" class="display">
             <thead>
             <tr>              
               <th>Student Name</th>
               <th>Roll No</th>
...
export default SecondStandardFeeTable2
