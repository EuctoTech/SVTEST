...
class ThirdStandardFeeTable3 extends React.Component {
  ...
  editLKG = async () => {
    try {
      ...
      const data = await response.json();
      $('#ThirdStandardFeeTable3').DataTable().ajax.reload();
      Swal.fire({
        icon: 'success',
...
<div className='pt-5' >
    <Modal className='mt-5' show={this.state.showModal} onHide={this.closeModal}>
       <Modal.Header closeButton>
         <Modal.Title>3rd Standard</Modal.Title>
       </Modal.Header>
       <Modal.Body>
         <Form>
         <Form.Control 
       ...
       <Modal.Footer>
         ...
         <div className="container">
           ...
           <table id="ThirdStandardFeeTable3" class="display">
             <thead>
             <tr>              
               <th>Student Name</th>
               <th>Roll No</th>
...
export default ThirdStandardFeeTable3
