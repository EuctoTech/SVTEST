...
class FirstStandardFeeTable extends React.Component {
  ...
  componentDidMount() {
    ...
    $(document).ready(function () {
      $('#FirstStandardFeeTable').DataTable({
        ...
        serverSide: true,
        ajax: {
          url: 'https://www.santhoshavidhyalaya.com/SVSTEST/api/studentsMaps/1',
          type: 'POST',
        },
        dom: 'lfBrtip',
        buttons: [
...
<div className='pt-5' >
    <Modal className='mt-5' show={this.state.showModal} onHide={this.closeModal}>
     ...
     <div className="container">
       ...
       <table id="FirstStandardFeeTable" class="display">
         <thead>
         <tr>              
           <th>Student Name</th>
           <th>Roll No</th>
...
export default FirstStandardFeeTable
