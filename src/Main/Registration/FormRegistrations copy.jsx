            ...
            <Row>
              <Col>
                ...
                <Form.Control
                  ...
                  {newIDProofdd ? (
                    <div>
                      <a href={newIDProofdd} target="_blank" rel="noopener noreferrer">
...
//   const [newIDProof, setNewIDProof] = useState('');
...
//     // Add the is_couple field to the data object if the checkbox is checked
//     if (isChecked) {
//       databody.is_couple = 1;
//     }else{
//       databody.is_couple = 0;
...
//                 <Form.Group>
//                   <Form.Label>Patient Name</Form.Label>
//                   <Form.Control value={newPatientName} onChange={(e)=> setNewPatientName(e.target.value)}
//                    autoComplete='off' type="text" placeholder="Enter Partner Name" />
//                 </Form.Group>
//               </Col>
//               <Col>
//                 <Form.Group>
...
//                   <Form.Label>Age</Form.Label>
//                   <Form.Control value={newAge} onChange={(e)=> setNewAge(e.target.value)}
//                   autoComplete='off' type="number" placeholder="Enter Age"  />
//                 </Form.Group>
//               </Col>
//               <Col>
//                 <Form.Group className='d-grid'>
...
//                   <Form.Label  className=''>Husband/Partner Name </Form.Label>
//                   <Form.Control value={newPartnerName} onChange={(e)=> setNewPartnerName(e.target.value)}
//                    autoComplete='off' type="text" placeholder="Enter Partner Number" />
//                 </Form.Group>
//               </Col>
//             </Row>
// {/*----------  Check-Box ----------------- */}
...
//               <Col>
//                 <Form.Group controlId="formBasicEmail">
//                   <Form.Label  className=''>Relation name </Form.Label>
//                   <Form.Control value={newRelationName} onChange={(e)=> setNewRelationName(e.target.value)}
//                    autoComplete='off' type="text" placeholder="Patient's Relative name" />
//                 </Form.Group>
//               </Col>
//               <Col>
//                 <Form.Group controlId="formBasicEmail">
...
//                   <Form.Label>Age</Form.Label>
//                   <Form.Control value={newRelationAge} onChange={(e)=> setNewRelationAge(e.target.value)}
//                    autoComplete='off' type="number" placeholder="Enter Number" />
//                 </Form.Group>
//               </Col>
//               <Col>
...
//                   <Form.Label>Referral Doctor</Form.Label>
//                   <Form.Control value={newReferralDoctor} onChange={(e)=> setNewReferralDoctor(e.target.value)}
//                    autoComplete='off' type="text" placeholder="Enter Doctor Name"  />
//                 </Form.Group>
//               </Col>
//               <Col>
//                 <Form.Group>
//                   <Form.Label>Reason</Form.Label>
//                    <Form.Control value={newReason} onChange={(e)=> setNewReason(e.target.value)} 
//                     autoComplete='off' type="text" placeholder="Enter Reason"  />
//                 </Form.Group>
//               </Col>
//             </Row>
// {/* ----------- Address and Address1 ---------- */}
...
//                   <Form.Label>Address Line1</Form.Label>
//                   <Form.Control value={newAddress} onChange={(e)=> setNewAddress(e.target.value)}
//                    autoComplete='off' type="text" placeholder="Address"  />
//                 </Form.Group>
//               </Col>
//               <Col>
//                <Form.Group controlId="formBasicEmail">
...
//                   <Form.Label>Alternate Phone Number</Form.Label>
//                    <Form.Control value={newAltnumber} onChange={(e)=> setNewAltnumber(e.target.value)}
//                    autoComplete='off' type="number" placeholder="Enter Alternate Number"  />
//                 </Form.Group>
//               </Col>
//             </Row>
// {/* ----------- Occupation and Native Place ---------- */}
...
//                   <Form.Label>Occupation</Form.Label>
//                   <Form.Control value={newOccupation} onChange={(e)=> setNewOccupation(e.target.value)}
//                    autoComplete='off' type="text" placeholder="Enter Occupation"  />
//                 </Form.Group>
//               </Col>
//               <Col>
//               <Form.Group controlId="formBasicEmail">
//                   <Form.Label>Native Place</Form.Label>
//                    <Form.Control value={newNativePlace} onChange={(e)=> setNewNativePlace(e.target.value)}
//                    autoComplete='off' type="text" placeholder="Enter Native Place"  />
//                 </Form.Group>
//               </Col>
//             </Row>
...
//                   <Form.Label>Email ID</Form.Label>
//                    <Form.Control value={newEmail} onChange={(e)=> setNewEmail(e.target.value)}
//                     autoComplete='off' type="email" placeholder="Enter Email ID"  />
//                 </Form.Group>
//               </Col>
//               <Col>
//                 <Form.Label>Source</Form.Label>
//                 <Form.Control value={newSource} onChange={(e)=> setNewSource(e.target.value)}
//                     autoComplete='off' type="text" placeholder="Which source did you find our hospital?"  />
//               </Col>
//             </Row>
// {/* ----------- Branch ------------------------ */}
//             <Row className='pb-3'>
...
//           <Col xs={12} md={6}>
//               <Form.Group controlId="formBasicEmail">
//                 <Form.Label className='pb-2'>Patient/Couple picture upload</Form.Label>
//               <div style={{ display: 'flex' }}>
//                 {!showCamera && !capturedImage && (
//                   <div className='mr-2'>
//                     <Button style={{background:'#81C548'}} onClick={() => document.getElementById('fileInput').click()}>Upload Picture</Button>
...
//                       style={{ display: 'none' }}
//                       onChange={handleUploadFile} />
//                     <Button style={{background:'#FF4A08'}} onClick={handleOpenCamera}>Took a Picture</Button>
//                     {errorMessage && <p style={{ color: 'red' }}>{errorMessage}</p>}
//                   </div>
//                 )}
//                 <div style={{ marginLeft: '20px', marginTop:'30px'}}>
...
//               <Form.Control type="file" value={newIDProof} onChange={(e)=> setNewIDProof(e.target.value)}/>
//             </Form.Group>  
//           </Col>
//         </Row>
